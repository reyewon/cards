...
const friendsQuestions = [
    "What's a kink you've been curious about but have never told anyone?",
    "Describe your ultimate sexual fantasy, no holds barred.",
    "What's the most adventurous thing you've ever done sexually?",
    "Have you ever had a sexual experience that completely changed your perspective on something?",
    "What's your opinion on porn? What's your favourite category to watch?",
    "What's one thing you're secretly really good at in bed?",
    "Have you ever had a crush on a friend? What was the fantasy you had about them?",
    "What's the sluttiest thing you've ever done and would you do it again?",
    "What's a non-physical trait in a person that gets you instantly turned on?",
    "What's your biggest turn-on? And what's your biggest turn-off?",
    "Have you ever been in a friends-with-benefits situation? How did it go?",
    "What's your favourite type of foreplay?",
    "Would you rather be dominant or submissive in bed? Or are you a switch?",
    "What's the story of your best-ever orgasm?",
    "What's a sexual 'deal-breaker' for you?",
    "Have you ever used sex toys? Which one is your favourite?",
    "What's a roleplay scenario you'd love to act out?",
    "How do you feel about dirty talk? Are you good at it?",
    "What's the naughtiest thought you've had in the last 24 hours?",
    "Have you ever been caught masturbating?",
    "What's your favourite part of your own body, and what's your favourite part of a potential partner's body?",
    "What's the longest you've gone without sex and why?",
    "If you could have a threesome with any two people (real or fictional), who would they be?",
    "What's your opinion on public displays of affection? How far is too far?",
    "Have you ever sent nudes? Have you ever received an unsolicited one?",
    "What's one thing you wish you were more confident about sexually?",
    "What's your favourite position and why?",
    "Do you have a 'type'? Describe it.",
    "What's the most embarrassing thing that's happened to you during sex?",
    "How important is a partner's sexual history to you?",
    "What's a sexual act you've never tried but want to?",
    "Have you ever had a one-night stand? Was it a good experience?",
    "What's your favourite kinky movie or TV show?",
    "What's something you find incredibly sexy that others might find weird?",
    "If we were to hook up, what's one thing you'd want to make sure we did?",
    "What's your go-to seduction move?",
    "Have you ever fantasised about someone you shouldn't have?",
    "What's the kinkiest text message you've ever sent or received?",
    "Would you ever film yourself having sex?",
    "What's your favourite thing about your own sexuality?",
];
...
const groupQuestions = [
    { text: "Who in this room do you think has the highest body count? No need for them to confirm or deny.", type: 'target' },
    { text: "Point to the person you'd most like to see in some form of bondage.", type: 'target' },
    { text: "Who here gives off secret 'submissive' energy?", type: 'target' },
    ...
    { text: "Ask one person in the group a sexual question you've always wanted to know the answer to. They can refuse to answer and take a forfeit instead.", type: 'target' },
    ...
    { text: "Which person here seems the most innocent, but you suspect is the biggest freak in the sheets?", type: 'target' },
    { text: "If you had to choose one person to share a partner with for a night, who would it be?", type: 'target' },
    { text: "Who in this room do you think has had sex in the most public place?", type: 'target' },
    ...
    { text: "Point to the person you think would be most likely to have a one-night stand.", type: 'target' },
    { text: "Who in the group would you want to be your 'Dom' for an evening?", type: 'target' },
    { text: "Who here do you think has faked an orgasm most recently?", type: 'target' },
    { text: "If you could swap bodies with one person in this room for a day, who would it be and what's the first thing you'd do?", type: 'target' },
    ...
    { text: "Who here do you think has the best underwear collection?", type: 'target' },
    ...
    { text: "Who here do you think has had the most threesomes?", type: 'target' },
